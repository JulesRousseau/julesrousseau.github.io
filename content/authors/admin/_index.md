...
I recently graduated with a master's degree in cryptography and I'm finished my internship in the research labs of Inria/Irisa at Rennes. I focused on searching cube attacks on symmetric algorithms including the [Ascon-128](https://csrc.nist.gov/CSRC/media/Projects/lightweight-cryptography/documents/round-2/spec-doc-rnd2/ascon-spec-round2.pdf) authenticated cipher. A huge part of my work was to model the ciphers in MILP (Mixed Linear Programming) to search for integral distinguishers, in C++. Here's my [internship report](https://hal.science/hal-04692191).
